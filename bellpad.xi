...
<INSTRUMENT>
<INFO>
<string name="name">Bell Pad</string>
<string name="author">Graham Breed</string>
<string name="comments">Interesting pad that's not what I'm looking for so I won't tweak it now</string>
...
<FREQUENCY_LFO>
<par_real name="freq" value="0.621181" />
...
<par_bool name="forced_release" value="yes" />
<par_bool name="linear_envelope" value="no" />
<par name="A_dt" value="91" />
<par name="D_dt" value="70" />
<par name="R_dt" value="98" />
<par name="A_val" value="99" />
<par name="D_val" value="64" />
<par name="S_val" value="64" />
